...
<body>
    ...
    <form action="Pesos Conversion.php" method="post">
        <label for="">Ingresa la cantidad de Pesos Mexicanos</label>
        <input type="number" name="pesos_mexicanos">
        <br>
