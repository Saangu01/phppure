...
<body>
    ...
    <form action="Grados Conversion.php" method="post">
        <label for="">Ingresa la cantidad de Grados Kelvin</label>
        <input type="number" name="grados_kelvin" id="grados_kelvin">
        <br>
